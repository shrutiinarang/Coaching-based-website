...
function openGoogleForm(courseName) {
  var formUrl = 'https://docs.google.com/forms/d/e/1FAIpQLScsirmY0GM8Z-jKkR4Mfb7cxQ_22vHPIqQWMZeVrvUyD03GVQ/viewform?usp=sf_link'; // Replace with your Google Form URL
  var formUrlWithEntry = formUrl + '&entry.<FIELD_ID>=<VALUE>'; // Replace FIELD_ID and VALUE with actual field id and value
  window.open(formUrlWithEntry, '_blank');
}
